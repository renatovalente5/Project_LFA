...
symb.put("var6", new Var("Integer", 0));
symb.put("var6", new Var("Integer", 0));
System.out.println(new Var((((Counts.add(new Var((symb.get("var3")).getType(), -(symb.get("var3")).getVal(), (symb.get("var3")).getNumDen()),symb.get("var1"))))).getType(), -(((Counts.add(new Var((symb.get("var3")).getType(), -(symb.get("var3")).getVal(), (symb.get("var3")).getNumDen()),symb.get("var1"))))).getVal(), (((Counts.add(new Var((symb.get("var3")).getType(), -(symb.get("var3")).getVal(), (symb.get("var3")).getNumDen()),symb.get("var1"))))).getNumDen()));
...
symb.get("var3").setVal(((Counts.mult((Counts.mult(symb.get("var1"),new Var((symb.get("var2")).getType(), -(symb.get("var2")).getVal(), (symb.get("var2")).getNumDen()))),symb.get("var3")))).getVal()); 
